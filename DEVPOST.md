...
MindGrid is built on that notion: show the map first. Upload a PDF → get the concept network → dive where it matters.

## What it does

MindGrid turns large PDFs into interactive concept networks with study materials:
