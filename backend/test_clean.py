...
PDF_PATH = "/path/to/your/test.pdf"  # Update this path to your test PDF

# Create output directory
OUTPUT_DIR = "./output"  # Output directory relative to script location
...
def test_clean_pipeline():
    ...
    print("=" * 70)
    print("🧠 MINDGRID CLEAN PIPELINE TEST")
    print("=" * 70)
